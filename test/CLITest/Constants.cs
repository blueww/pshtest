...
namespace Management.Storage.ScenarioTest
{
    public class Constants
    {
        ...
        {
            public const string Standard_LRS = "StandardLRS";
            public const string Standard_ZRS = "StandardZRS";
            public const string Standard_GRS = "StandardGRS";
            public const string Standard_RAGRS = "StandardRAGRS";
            public const string Premium_LRS = "PremiumLRS";
        };
