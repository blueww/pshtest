...
namespace Management.Storage.ScenarioTest.Functional.CloudFile
{
    ...
    public class FileAsyncCopyRandomCredentials : TestBase
    {
        ...
        //TODO: Currenlty xPlat's api-version is not consistent with api-version in the SAS generated by .NET XCL 6.1. After the xPlat/NodeJS CL upgrade the api-version, update the case accordingly
